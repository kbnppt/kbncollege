...
import ChemistryAbout from './ChemistryDep/ChemistryAbout';
import ChemistryFaculty from './ChemistryDep/ChemistryFaculty';
import ChemistryAchivements from './ChemistryDep/ChemistryAchivements';
import ChemistryEvents from './ChemistryDep/ChemistryEvents';
import ChemistryLabs from './ChemistryDep/ChemistryLabs';
import ChemistryMore from './ChemistryDep/ChemistryMore';


const DeptOfChemistry = () => {

    const data = [
        { id: 1, title: 'Home', componentInfo: <ChemistryHome /> },
        { id: 2, title: 'About', componentInfo: <ChemistryAbout /> },
        { id: 3, title: 'Faculty', componentInfo: <ChemistryFaculty /> },
        { id: 4, title: 'Achivements', componentInfo: <ChemistryAchivements /> },
        { id: 5, title: 'Events', componentInfo: <ChemistryEvents /> },
        { id: 6, title: 'Labs', componentInfo: <ChemistryLabs /> },
        { id: 7, title: 'KMore', componentInfo: <ChemistryMore /> },
    ];
