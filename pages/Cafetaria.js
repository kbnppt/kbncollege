...
// import placementslogo from '../public/images/placements.png';
// import speechlogo from '../public/images/speech.JPG';
// import speech2logo from '../public/images/speech2.JPG';
// import speech3logo from '../public/images/speech3.JPG';
...
const Cafetaria = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Cafetaria - Kakaraparti Bhavanarayana College (Autonomous)
        </title>
      </Head>
      <main>
        <div className={classes.root}>
          ...
          <div className={classes.headerStyle}>
            <Container>
              <HeadingComponent data1="Cafetaria" data2="" Color={true} />
            </Container>
          </div>
          ...
          >
            <div className={classes.GalleryStyle}>
              <Image
                src={"/images/Gallery/Cafeteria/VVR_8335.JPG"}
                alt=""
                width={350}
                height={200}
            ...
            <div className={classes.GalleryStyle}>
              <Image
                src={"/images/Gallery/Cafeteria/VVR_8336.JPG"}
                alt=""
                width={350}
                height={200}
              />
            ...
            <div className={classes.GalleryStyle}>
              <Image
                src={"/images/Gallery/Cafeteria/VVR_8337.JPG"}
                alt=""
                width={350}
                height={200}
              />
            ...
            <div className={classes.GalleryStyle}>
              <Image
                src={"/images/Gallery/Cafeteria/VVR_8338.JPG"}
                alt=""
                width={350}
                height={200}
              />
            ...
            <div className={classes.GalleryStyle}>
              <Image
                src={"/images/Gallery/Cafeteria/VVR_8340.JPG"}
                alt=""
                width={350}
                height={200}
              />
            ...
            <div className={classes.GalleryStyle}>
              <Image
                src={"/images/Gallery/Cafeteria/VVR_8342.JPG"}
                alt=""
                width={350}
                height={200}
              />
            ...
            <div className={classes.GalleryStyle}>
              <Image
                src={"/images/Gallery/Cafeteria/VVR_8343.JPG"}
                alt=""
                width={350}
                height={200}
              />
            ...
            <div className={classes.GalleryStyle}>
              <Image
                src={"/images/Gallery/Cafeteria/VVR_8344.JPG"}
                alt=""
                width={350}
                height={200}
              />
